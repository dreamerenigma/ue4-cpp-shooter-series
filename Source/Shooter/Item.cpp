	...
	bCharacterInventoryFull(false)
{
	...
	CollisionBox = CreateDefaultSubobject<UBoxComponent>(TEXT("ColissionBox"));
...
void AItem::BeginPlay()
{
	...
	// Sets ActiveStars array besed on Item Rarity
	SetActiveStars();
...
void AItem::FinishInterping()
{
	...
	if (Character)
	{
		// Substarct 1 from the Item Count of the interp location struct
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	{
		// Elapsed time since we started ItemInterTimer
...
{
	// Load the data in the Item Rarrity Data Table
