...
struct FInterpLocation
{
	...
	// Scene component to use fot its location for interping
...
protected:
	...
	*/
	...
	/** Detach weapon and let it fall to the groung */
	void DropWeapon();
	...
	/** Checks to see if we have ammo of teh EquippedWeapon's ammo type */
	bool CarryingAmmo();
...
private:
	...
	/** Set this is Blueprints for teh default Weapon class */
	...
	/** Delegate for sending slot information InventoryBar when equipping */
	UPROPERTY(BlueprintAssignable, Category = Delegates, meta = (AllowPrivateAccess = "true"))
	FEquipItemDelegate EquipItemDelegate;

	/** Delegate for sending slot information fùr playing the icon animation */
	UPROPERTY(BlueprintAssignable, Category = Delegates, meta = (AllowPrivateAccess = "true"))
...
public:
	...
	/** Adds/substract to/from OverlappedItemCount and updates bShouldTraceForItems */
	...
	void IncrementInterpLocItemCount(int32 Insex, int32 Amount);
