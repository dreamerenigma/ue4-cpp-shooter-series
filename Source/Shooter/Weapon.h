...
private:
	...
	/** Particle system spawned at the BarrelsSocket */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = DataTable, meta = (AllowPrivateAccess = "true"))
	...
	/** Amount thay the slide pushed back during pistol fire */
	...
	/** Timer handle for updating SlideDisplacemet */
	...
	/** Amount that tje pistol will rotate during pistol fire */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Pistol, meta = (AllowPrivateAccess = "true"))
	...
	/** Amount of damege cause by a bullet */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Weapon Properties", meta = (AllowPrivateAccess = "true"))
	float Damage;
...
public:
	...
	/** Called from Character class whe firing weapon */
	void DecrementAmmo();
