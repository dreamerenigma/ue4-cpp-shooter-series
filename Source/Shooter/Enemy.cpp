...
void AEnemy::BulletHit_Implementation(FHitResult HitResult)
{
	...
	// Determine wheter bullet hit stuns
...
float AEnemy::TakeDamage(float DamageAmount, FDamageEvent const& DamageEvent, AController* EventInsigator, AActor* DamageCauser)
{
	if (EnemyController)
	{
