...
void UShooterAnimInstance::UpdateAnimationProperties(float DeltaTime)
{
	...
	if (ShooterCharacter)
	{
		...
		bShouldUseFABRIK = ShooterCharacter->GetCombatState() == ECombatState::ECS_Unoccupied || ShooterCharacter->GetCombatState() == ECombatState::ECS_FireTimerProgress;
...
void UShooterAnimInstance::TurnInPlace()
{
	...
	if (Speed > 0 || bIsInAir)
	{
		// Don't want turn in place; Character is moving
		RootYawOffset = 0.f;
